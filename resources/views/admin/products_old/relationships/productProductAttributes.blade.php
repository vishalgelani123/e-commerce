<div class="m-3">
    @can('product_attribute_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary" href="{{ route('admin.product-attributes.create') }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-productProductAttributes">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  let table = $('.datatable-productProductAttributes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
