...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" class="form-row" action="{{ route("admin.testimonials.update", [$testimonial->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group col-2">
                <label class="required" for="gender">Gender</label>
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}"  name="gender" id="gender" value="{{ old('gender', $testimonial->gender) }}" required>
            ...
            <div class="form-group col-4">
                ...
                <input class="form-control {{ $errors->has('full_name') ? 'is-invalid' : '' }}" type="text" name="full_name" id="full_name" value="{{ old('full_name', $testimonial->full_name) }}" required>
            ...
            <div class="form-group col-2">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $testimonial->city) }}" required>
                @if($errors->has('city'))
            ...
            <div class="form-group col-md-4">
                ...
                <span class="mx-2 text-secondary" id="img-name">{{$testimonial->image}}</span>
                @if ($errors->has('image'))
