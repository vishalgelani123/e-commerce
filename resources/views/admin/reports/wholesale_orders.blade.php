        ...
        <div class="card-body">
            <form action="" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="end_date" id="end_date" class="form-control end_date datepicker" placeholder="End Date" readonly>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ url('backoffice/reports/wholesale_orders') }}" class="btn btn-danger clear_btn">Clear</a>
                    </div>
                </div>
            </form>
            <br>
    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                ajax: {
                    url: "{{ route('admin.reports.wholesale_orders') }}",
                    data: function (d) {
