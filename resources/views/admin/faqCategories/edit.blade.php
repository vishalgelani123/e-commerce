    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.faq-categories.update", [$faqCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $faqCategory->description) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.faq-categories.storeCKEditorImages') }}', true);
                ...
                data.append('crud_id', '{{ $faqCategory->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
