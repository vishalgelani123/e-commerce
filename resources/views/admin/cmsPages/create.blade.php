...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" class="form-row" action="{{ route("admin.cms-pages.store") }}" enctype="multipart/form-data">
            @csrf
          ...
          <div class="form-group col-3">
            ...
            <div class="form-group col-12">
                <label for="ckeditor">{{ trans('cruds.cmsPage.fields.description') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="ckeditor">{!! old('description') !!}</textarea>
