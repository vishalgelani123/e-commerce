...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset("file/$setting->favicon")); ?>" type="image/*">

    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet" />

    <link href="<?php echo e(asset('assets/vendor/css/select2.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/vendor/css/adminltev3.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/vendor/css/bootstrap-datetimepicker.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/vendor/css/jquery.dataTables.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/vendor/css/dataTables.bootstrap4.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/vendor/css/select.dataTables.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/vendor/css/buttons.dataTables.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/vendor/css/dropzone.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('assets/vendor/css/sweetalert.css')); ?>" rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('assets/css/bootstrap4-toggle.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('toast/toastr.css')); ?>" rel="stylesheet" />
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('profile_password_edit')): ?>
                            <a class="dropdown-item" href="#">
                                <?php echo app('translator')->get('global.profile'); ?>
                            </a>
                            <a class="dropdown-item" href="<?php echo e(route('profile.password.edit')); ?>">
                                <?php echo app('translator')->get('global.change_password'); ?>
                            </a>
                        <?php endif; ?>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"
                            onclick="event.preventDefault(); document.getElementById('logoutform').submit();">
                            <?php echo app('translator')->get('global.logout'); ?>
                        </a>
                    </div>
                </li>
            </ul>
        ...
        <div class="content-wrapper" style="min-height: 917px;">
            ...
            <section class="content" style="padding-top: 20px">
                ...
                <?php if(session('error')): ?>
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="alert alert-warning" role="alert"><?php echo e(session('error')); ?></div>
                        </div>
                    </div>
                <?php endif; ?>
                <?php if(isset($errors) && is_array($errors) && $errors->count() > 0): ?>
    ...
    <script src="<?php echo e(asset('assets/vendor/js/select2.full.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/moment.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/dataTables.bootstrap4.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/dataTables.buttons.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/dataTables.select.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/buttons.flash.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/buttons.html5.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/buttons.print.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/buttons.colVis.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/pdfmake.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/vfs_fonts.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/jszip.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/ckeditor.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/bootstrap-datetimepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/dropzone.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/main.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/js/sweetalert.js')); ?>"></script>
...
<?php /**PATH E:\laragon\www\adaajaipur\resources\views/layouts/admin.blade.php ENDPATH**/ ?>