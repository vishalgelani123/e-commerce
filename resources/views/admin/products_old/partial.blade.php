                ...
                <div class="col-2">
                        <div class="icheck-primary {{ $errors->has('same_price') ? 'is-invalid' : '' }}" style="display : inline-block";>
                            <input type="checkbox" name="same_price[]" id="same_price{{ $color->id }}"
                                ...
                                value="{{ $loop->iteration }}"  @if (isset($product->productProductVariations()->where('color_id',$color->id)->first()->color_id) && $product->productProductVariations()->where('color_id',$color->id)->first()->color_id == $color->id)
                                checked
                    ...
                    <div class="form-group col-4">
                        <input class="form-control"
                          ...
                          value="{{ old('price',$product->productProductVariations->where('color_id',$color->id)->first()->single_price??'') }}" oninput="txtSinglePrice('{{ $color->id }}')" onkeypress="return isFloat(event)"
                    ...
                    <div class="form-group col-4">
                        <input class="form-control"
                            ...
                            value="{{ old('single_price_quantity',$product->productProductVariations->where('color_id',$color->id)->first()->single_price_quantity ?? '') }}" oninput="txtSinglePriceQuantity('{{ $color->id }}')" onkeypress="return isFloat(event)"
                    ...
                    //   dd($color->id);
                      ...
                      <div class="col-2" id="{{strtok($img->file_name, '.')}}">
                        <div class="border p-2" id="add-image">
                            ...
                            <img onerror="handleError(this);"src="{{asset("file/$img->file_name")}}" class="w-100" style="height : 150px;">
                            <input type="hidden" name="gallery[{{$color->id}}][]" value="{{$img->file_name}}">
                        </div>
                      </div>
                      @endforeach
