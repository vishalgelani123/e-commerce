...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" class="form-row" id="editStoreForm" action="{{ route("admin.stores.update", [$store->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <select type="text" class="form-control {{ $errors->has('city_id') ? 'is-invalid' : '' }}" name="city_id" id="city_id" value="{{ old('city_id', $store->city_id) }}" required style="width : 100%;">
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" name="location" id="location" value="{{ old('location', $store->location) }}" required>
                    @if($errors->has('location', $store->location))
            ...
            <div class="form-group col-4">
                ...
                <input class="form-control {{ $errors->has('contact_person_name') ? 'is-invalid' : '' }}" type="text" name="contact_person_name" id="contact_person_name" value="{{ old('contact_person_name', $store->contact_person_name) }}" required>
            ...
            <div class="form-group col-4">
                ...
                <input class="form-control {{ $errors->has('contact_person_number') ? 'is-invalid' : '' }}" type="text" name="contact_person_number" id="contact_person_number" value="{{ old('contact_person_number', $store->contact_person_number) }}" required>
            ...
            <div class="form-group col-4">
                ...
                <input class="form-control {{ $errors->has('contact_person_designation') ? 'is-invalid' : '' }}" type="text" name="contact_person_designation" id="contact_person_designation" value="{{ old('contact_person_designation', $store->contact_person_designation) }}">
            ...
            <div class="form-group col-4">
                ...
                <input class="form-control {{ $errors->has('store_pin_code') ? 'is-invalid' : '' }}" type="text" name="store_pin_code" id="store_pin_code" value="{{ old('store_pin_code', $store->store_pin_code) }}" required>
            ...
            <div class="form-group col-4">
                ...
                <input class="form-control {{ $errors->has('store_contact') ? 'is-invalid' : '' }}" type="text" name="store_contact" id="store_contact" value="{{ old('store_contact', $store->store_contact) }}" required>
            ...
            <div class="form-group col-2">
                ...
                <input class="form-control timepicker {{ $errors->has('open_time') ? 'is-invalid' : '' }}" type="text" name="open_time" id="open_time" value="{{ old('open_time', $store->open_time) }}" required>
            ...
            <div class="form-group col-2">
                ...
                <input class="form-control timepicker {{ $errors->has('close_time') ? 'is-invalid' : '' }}" type="text" name="close_time" id="close_time" value="{{ old('close_time', $store->close_time) }}" required>
            ...
            <div class="col-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" name="latitude" id="latitude" value="{{ old('latitude', $store->latitude) }}" required>
            ...
            <div class="col-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" name="longitude" id="longitude" value="{{ old('longitude',$store->longitude) }}" required>
            ...
            <div class="form-group col-4">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\Store::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $store->status) == (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-4">
              ...
              <div class="image-load">
                    <img onerror="handleError(this);"src="{{asset("file/$store->image")}}" style="width : 120px;" class="my-2">
                    <input type="hidden" name="image" id="editimage" value="{{$store->image}}">
              </div>
            </div>
            <div class="col-4">
                <label class="required" for="iframe">Iframe</label>
                <textarea class="form-control {{ $errors->has('iframe') ? 'is-invalid' : '' }}" name="iframe" id="iframe" styles="rows : 1 !important" required>{{ old('iframe', $store->iframe) }}</textarea>
            ...
            <div class="form-group col-4">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address" required>{{ old('address', $store->address) }}</textarea>
            ...
            <div class="form-group col-4">
                ...
                <textarea class="form-control {{ $errors->has('pin_codes') ? 'is-invalid' : '' }}"  name="pin_codes" id="pin_codes" required> {{ old('pin_codes', $store->pin_codes) }} </textarea>
            ...
            <div class="form-group text-right col-12">
                <button class="btn btn-warning" type="button" id="storeUpdate">
                    {{ trans('global.update') }}
                </button>
            </div>
        </form>
...
<script>
    ...
    $(document).on('click','#storeUpdate', function(e){
        var checkimage = $('#editimage').val();
        if(checkimage != ""){
            document.getElementById("editStoreForm").submit();
        } else {
            toast_alert('Store Images');
            return;
        }
    });
