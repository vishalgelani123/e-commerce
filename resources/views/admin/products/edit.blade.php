                        ...
                        <div id="productDetail" class="collapse show" aria-labelledby="productDetails"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-3" id="child-category" @if($product->sub_category_child_id!=null) "" @else style="display:none" @endif>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea class="form-control editor-details {{ $errors->has('details') ? 'is-invalid' : '' }}" name="details"
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description"
                                            id="editor" required>{!! old('description', $product->description) !!}</textarea>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea class="form-control desc {{ $errors->has('need_help') ? 'is-invalid' : '' }}" name="need_help"
                                            id="need_help" required>{!! old('need_help', $product->need_help) !!}</textarea>
                                                            ...
                                                            @foreach ($sizes as $key => $size)
                                                                ...
                                                                <div class="form-group col-3">
                                                                    ...
                                                                    <input class="form-control single_price_{{ $color->id }} {{ $errors->has('price') ? 'is-invalid' : '' }}"
                                                                        ...
                                                                        value="{{ old('price',$price) }}" onkeypress="return isFloat(event)"
                                                                ...
                                                                <div class="form-group col-3">
                                                                    ...
                                                                    <input class="form-control single_price_quantity_{{ $color->id }} {{ $errors->has('single_price_quantity') ? 'is-invalid' : '' }}"
                                                                        type="text" name="variation[{{ $color->id }}][single_price_quantity][]" value="{{ old('single_price_quantity',$qty) }}"
