...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" class="form-row" id="attributes-form" action="{{ route('admin.attributes.update', [$attribute->id]) }}"
                ...
                <div class="form-group col-6" id="value-container">
                    ...
                    <div class="row mt-2" >
                       <div class="col-10">
                         <input type="text" class="form-control" name="{{$value->id}}" name="values[]" id="values" value="{{$value->value}}">
                       </div>
                       <div class="col-1">
                           @if($i !== 1)
