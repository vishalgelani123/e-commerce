...
(function ($) {
	...
	function add_value(id){ //main_price Price-currencySymbol 0
		var id1='quantity'+id;
		var val=document.getElementById(id1).value;
		val=Number(val)+1;
		document.getElementById(id1).value=val;
		var pid='main_price'+id;
		var mprice=document.getElementById(pid).innerHTML;
		var mp=mprice*val;
		console.log(mp);
		pid='Price-currencySymbol'+id;
		document.getElementById(pid).innerHTML=mp.toFixed(2);
		}
		function sub_value(id){
			var id1='quantity'+id;
			var val=document.getElementById(id1).value;
			if(val>1){
			val=Number(val)-1;
	...
	function payment(){
		...
		var lname=document.getElementById('shipping_company').value;
		var lname=document.getElementById('shipping_country').value;
		var street_add=document.getElementById('street_add').value;
		var lname=document.getElementById('apartment_add').value;
		var lname=document.getElementById('shipping_city').value;
		var lname=document.getElementById('shipping_state').value;
		var lname=document.getElementById('shipping_postcode').value;
		var lname=document.getElementById('shipping_phone').value;
		var lname=document.getElementById('shipping_email').value;
	}
