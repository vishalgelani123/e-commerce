...
(function($) {
    $.loader_ext = {
        ...
        defaults: {
            ...
            title: '', //文字
            isOnly: true,
            imgUrl: "asset('assets/images')/loading[size].gif",
            onShow: function() {}, //打开回调
    ...
    // 简单开启关闭以及设置模板
    $.loader = {
        tmpl: '<div class="loading_wrp"><div class="loading ${Class}"><img onerror="handleError(this);"src="${Src}" /><span>${Title}</span></div></div>',
