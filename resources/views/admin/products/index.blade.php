...
@section('content')
    <div class="row bg-light my-2" id="select-bg">
        <div class="col-12 text-center bg-light">
            <form id="import_product_form" action="{{ route('admin.products.import') }}" method="POST"
                enctype="multipart/form-data">
                @csrf

                {{-- <button class="btn btn-lg btn-primary  border" style="border-radius : 25px;" id="all">Products</button> --}}

                <a class="btn btn-primary float-right import_product_btn border" type="button" href="{{ asset('assets/product.xlsx') }}"style="border-radius : 25px;color:white !important" download>Download Sample</a>
