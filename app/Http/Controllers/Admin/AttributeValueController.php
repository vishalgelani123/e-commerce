...
class AttributeValueController extends Controller
{
    ...
    public function create()
    {
        ...
        $attributes = Attribute::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
    ...
    public function store(StoreAttributeValueRequest $request)
    {
        ...
        return redirect()->route('admin.attribute-values.index')->with('success',trans('global.create_success'));
    }
    ...
    public function edit(AttributeValue $attributeValue)
    {
        ...
        return view('admin.attributeValues.edit', compact('attributes', 'attributeValue'));
    }
    ...
    public function update(UpdateAttributeValueRequest $request, AttributeValue $attributeValue)
    {
        ...
        return redirect()->route('admin.attribute-values.index')->with('success',trans('global.update_success'));
    }
