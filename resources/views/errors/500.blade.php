  ...
  @media screen and (max-width: 370px) {
    ...
    <body>
        ...
        <div class="error">
            <h1>500</h1>
            <h2>error</h2>
            <h4 style="font-size : 38px;font-weight : bold;color : #FF508E;">vasvi.in</h4>
            <p>Something just isn't right... Time to go through your logs and get down and dirty in your
                stack-trace;)</p>
        </div>
