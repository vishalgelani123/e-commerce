...
<div class="card">
    <div class="card-header">
        {{ trans('global.update') }} {{ trans('cruds.slider.title_singular') }}
    ...
    <div class="card-body">
        <form method="POST" class="form-row" action="{{ route('admin.trendsliders.update', [$slider->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
