    ...
    <div class="card">
        <div class="card-header">
                ...
                <a class="btn btn-secondary float-right"
                    href="{{ route('admin.latestbanners.index') }}">
                   Back to Banners
                </a>

        </div>
        <div class="card-body">
            <form method="POST" action="{{route('admin.latestbanners.update',$banner->id)}}"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        @endif
                        <br>
                        <span class="text-warning">We suggest using images that are 640px by 1138px, or 1080px by 1920px & image size shoulg be maximum 200px</span>
