...
@section('content')
    {{-- @can('slider_create') --}}
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <!-- <a class="btn btn-primary float-right" href="{{ route('admin.sliders.create') }}">
                    {{ trans('global.add') }} Footer
                </a> -->
            </div>
        </div>
    {{-- @endcan --}}
    ...
    <script>
        $(function() {
            ...
            $(document).on('click','#is-attribute-chk', function(){
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route('footer.status.update') }}",
