...
<head>
    ...
    <link rel="icon" href="{{asset("file/$setting->favicon")}}" type="image/*">
    ...
    <link href="{{ asset('assets/vendor/css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/vendor/css/jquery.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/vendor/css/dataTables.bootstrap4.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/vendor/css/select.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/vendor/css/buttons.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/vendor/css/dropzone.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/vendor/css/sweetalert.css') }}" rel="stylesheet" />
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="min-height: 917px;">
            ...
            <section class="content" style="padding-top: 20px">
                ...
                @endif
                @if (isset($errors) && is_array($errors) && $errors->count() > 0)
    ...
    <script src="{{ asset('assets/vendor/js/select2.full.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/moment.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/dataTables.bootstrap4.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/dataTables.buttons.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/dataTables.select.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/buttons.flash.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/buttons.html5.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/buttons.print.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/buttons.colVis.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/pdfmake.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/vfs_fonts.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/jszip.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/ckeditor.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/bootstrap-datetimepicker.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/dropzone.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/main.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/sweetalert.js') }}"></script>
