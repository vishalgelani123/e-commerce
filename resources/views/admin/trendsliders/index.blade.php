...
@section('content')
    {{-- @can('slider_create') --}}
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary" href="{{ route('admin.trendsliders.create') }}">
                    {{ trans('global.add') }} Trending Slider
                </a>
            </div>
        </div>
    {{-- @endcan --}}
    <div class="card">
        <div class="card-header">
            Trending Slider {{ trans('global.list') }}
        </div>
    ...
    <script>
        $(function() {
            ...
            @can('slider_delete')
                ...
                url: "{{ route('admin.trendsliders.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.trendsliders.index') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
            ...
            $(document).on('click','#is-attribute-chk', function(){
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route('admin.trendsliders.status.update') }}",
